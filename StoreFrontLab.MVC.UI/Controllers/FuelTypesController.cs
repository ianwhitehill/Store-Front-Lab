...
namespace StoreFrontLab.MVC.UI.Controllers
{
    public class FuelTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FuelTypeID,FuelTypes")] FuelType fuelType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FuelTypeID,FuelTypes")] FuelType fuelType)
        {
            if (ModelState.IsValid)
            {
